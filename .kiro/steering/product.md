...
affinity score are returned and compared to the target's reference drug. A new
disease is added by writing a target specification — the pipeline is generated
from that spec. Target users: under-resourced research groups. Goal: make early
virtual screening usable from a browser.
