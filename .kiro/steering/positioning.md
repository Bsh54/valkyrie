...
Honesty is a feature. Target users: under-resourced academic labs, students/educators,
ethnobotany researchers. A lasting goal is to publish an open, reusable
ethnobotanical + molecular dataset (plants -> preparations -> compounds -> docking
results) as a real scientific contribution beyond the app.
