...
DATA_DIR = _path_from_env("VALKYRIE_DATA_DIR", PROJECT_ROOT / "data")
STATIC_DIR = _path_from_env("VALKYRIE_STATIC_DIR", PROJECT_ROOT / "static")
...
DB_PATH = _path_from_env("VALKYRIE_DB_PATH", DATA_DIR / "results.db")
...
VINA_CPU = _int_from_env("VALKYRIE_VINA_CPU", 2)
...
HTTP_TIMEOUT_S = _int_from_env("VALKYRIE_HTTP_TIMEOUT", 15)
